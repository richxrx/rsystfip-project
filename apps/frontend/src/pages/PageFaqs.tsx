        ...
        >
            ...
            >
              ...
              <AccordionDetails>
                <Typography>
                  ...
                  registradas en el aplicativo por una visita a la rectoría,
                  debes ir a la seccion de
                  <code> Personas</code> que se encuentra en la barra superior
                  de todas las secciones del aplicativo y acceder a esa opción,
                  para ver toda la información pertinente de cada persona.
                </Typography>
              </AccordionDetails>
            </Accordion>
            ...
            >
              ...
              <AccordionDetails>
                <Typography>
                  ...
                  se dirige a la opción de
                  <code> Agendar </code>, y luego completar el formulario de
                  agendamiento, el cual es el mismo excluyendo la diferencia de
                  seleccionar la fecha y hora, ya que es en el mismo instante y
                  ésta es guardada automáticamente al enviar el formulario.
                </Typography>
              </AccordionDetails>
            </Accordion>
          </Grid>
          ...
          <Grid item md>
            ...
            >
              ...
              <AccordionDetails>
                <Typography>
                  Para generar reportes y poderlos visualizar facilmente, se
                  debe dirigir a la sección de
                  <code> Reportes</code>, y dar click en el menu desplegable,
                  ...
                  puede especificar el tipo de persona que visitaron la rectoría
                  y darle click en
