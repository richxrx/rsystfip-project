        ...
        <Accordion>
          ...
          <Accordion.Item className="border-0" eventKey="1">
            ...
            <Accordion.Body>
              <p>
                ...
                arriba en la barra superior de opciones del aplicativo. Una vez
                estando en la vista de calendario, seleccionar el dia dando
                click en el recuadro y dentro en el número del día ó en la barra
                lateral del calendario de agendamientos da click en semana
                (week) o día (day) para agendar en el dia que hayas seleccionado
                y por último arrastrar y soltar hasta la hora que requiera el
                agendamiento.
              </p>
              <p>
                Completar el formulario de agendamiento con todos los datos que
                pida, por último enviar el formulario para completar el proceso.
              </p>
              <p>
                <strong>Nota:</strong> El día o semana seleccionada en el
                calendario de agendamientos se puede cambiar fácil y
                sencillamente usando las flechas que aparecen la parte superior
          ...
          <Accordion.Item className="border-0" eventKey="2">
            ...
            <Accordion.Body>
              ...
              entonces en este instante se hace dicho agendamiento, para eso se
              dirige a la opción de
              <code> Agendar </code>, y luego completar el formulario de
              agendamiento, el cual es el mismo excluyendo la diferencia de
              seleccionar la fecha y hora, ya que es en el mismo instante y ésta
              es guardada automáticamente al enviar el formulario.
            </Accordion.Body>
          </Accordion.Item>
        </Accordion>
      </Col>
        ...
        <Accordion>
          ...
          <Accordion.Item className="border-0" eventKey="1">
            ...
            <Accordion.Body>
              ...
              <code> Reportes</code>, y dar click en el menu desplegable, luego
              seleccionar la opción
              <code> Generar reporte de agendamientos</code> y luego seleccionar
              la fecha entre la cual desea el reporte, tambien puede especificar
              el tipo de persona que visitaron la rectoría y darle click en
          ...
          <Accordion.Item className="border-0" eventKey="2">
            ...
            <Accordion.Body>
              <p>
                ...
                completar las opciones que requiera para filtrar la información,
                despues se debe dar click en
